...
import default_pic from "../static/images/default.png";
...
const Navbar = ({ user }) => {
  ...
  const HandleDropdown = () => {
    const d = document.querySelector(".drop-down");
    if (toggle === false) {
        ...
        <div class="drop-down">
          <div
            ...
            style={{
              ...
              boxShadow: "-5px -5px 5px 0px rgb(0 0 0 / 10%)",
            }}
          ></div>
          ...
          <ul>
            ...
            <li style={{ borderTop: "2px solid #dbdbdb" }}>
